...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        scoretext.GetComponent<Text>().text = PlayerPrefs.GetInt("scoretext").ToString("F0");
        charging = false;
    ...
    private void Update()
    {
        ...
        if (Input.GetKey(KeyCode.D) && !Input.GetKey(KeyCode.A) && PlayerPrefs.GetInt("canMove") == 1 && charging == false)
        {
            rotateY = 0f;
        ...
        else if (Input.GetKey(KeyCode.A) && !Input.GetKey(KeyCode.D) && PlayerPrefs.GetInt("canMove") == 1 && charging == false)
        {
            rotateY = 180f;
        ...
        if (Input.GetKey(KeyCode.W) && Grounded && PlayerPrefs.GetInt("canMove") == 1 && charging == false)
        {
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.CompareTag("Goal"))
        {
            ...
            scoretext.GetComponent<Text>().text = PlayerPrefs.GetInt("scoretext").ToString("F0");
            if(PlayerPrefs.GetInt("scoretext") >= 2)
            {
        ...
        {
            if(collision.gameObject.name != "Player 1 Head")
            {
                Grounded = true;
            }
